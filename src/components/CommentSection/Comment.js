        ...
        <div className={commentStyle.center_div}>
          <div className={commentStyle.leftside_portion}>
            <div className={commentStyle.user_detail}>
              <span className={commentStyle.userName}>
                {" "}
              ...
              <div>
                <div className={commentStyle.chatHeader}>
                  ...
                  <div className={commentStyle.messagePart}>
                    {message.map((val, i) => {
                      return (
                        <p className={commentStyle.message} key={i}>
                          {val}
                        </p>
                      );
                    })}
                  ...
                  <input
                    className={commentStyle.chatInput}
                    type="text"
                    value={chatData}
                    placeholder="Message"
                    onChange={chatDataHandler}
                  ></input>
                  <button
